...
order_dow is given as an integer but to make it human readable let’s
change it to a string. We don’t know which day is which but in order to
find out we can see the distribution by day and assume that the most
orders happen on Monday (since on Saturday and Sunday people are more
likely to go grocery shopping themselves).
...
For example, the first order in the dataset was made by 112108 at 10 o
clock and we can see they ordered c(“Bulgarian Yogurt”, “Organic 4% Milk
Fat Whole Milk Cottage Cheese”, “Organic Celery Hearts”, “Cucumber
Kirby”, “Lightly Smoked Sardines in Olive Oil”, “Bag of Organic
Bananas”, “Organic Hass Avocado”, “Organic Whole String Cheese”) (of
which c(“Bulgarian Yogurt”, “Organic 4% Milk Fat Whole Milk Cottage
Cheese”, “Lightly Smoked Sardines in Olive Oil”, “Organic Whole String
Cheese”) were reordered).
...
<img src="p8105_hw3_jg5038_files/figure-gfm/unnamed-chunk-4-1.png" width="90%" />

In order to find the most popular items for each aisle let’s use group
by:
...
In order to find how many zipcodes are observed for all 116 months and
how many observed less than 10 times, we will use summarize:
...
by COVID across the other boroughs.
...
Since each row is already 1 zipcode per month there is nothing to
average, it will just be the rent index in the row. We can confirm this
because when we calculate the mean it is the same as if we just filtered
and grouped by (since the n is 1).
...
Again we can see the higher average and higher variance in Manhattan and
relatively low variance in Staten Island. There does not seem to be much
difference across the months of year although there is a faint bump in
June-August across all boroughs (especially in Manhattan), which likely
corresponds to students coming to New York City for a summer internship.
...
<img src="p8105_hw3_jg5038_files/figure-gfm/unnamed-chunk-13-1.png" width="90%" />
...
Let’s create vizualization of age distribution for men and women in each
age category:
...
<img src="p8105_hw3_jg5038_files/figure-gfm/unnamed-chunk-16-1.png" width="90%" />
...
We have the most participants in the ‘more than highschool’ education
category and this is especially pronounced for women under 40.
...
We can see that generally activity goes down with age and this was more
pronounced in the participants with less than high school education.
There was no significant different between men and women in any of the
education groups
...
<img src="p8105_hw3_jg5038_files/figure-gfm/unnamed-chunk-19-1.png" width="90%" />

We can see that there is a general arc of activity throughout the day
across all groups, which makes sense. In the education groups with
highschool or more than highschool education we can see that females
were slightly more active in the morning and middle of the day.
